...
<!-- NAV BAR //////ADD LINKS LATER\\\\\\ -->
    ...
    <div class="card" style="border-radius:20px;">
        ...
        <!--Header-->
        <div class="header pt-3 peach-gradient" style="border-radius:20px 20px 0px 0px;">

            <div class="row d-flex justify-content-center">
                <h3 class="white-text mb-3 pt-3 font-weight-bold" style="padding-bottom:10px;">ABOUT BE EVERGREEN</h3>
            </div>
