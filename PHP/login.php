    ...
    <div class="container" id="sign-up">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" style="padding:10px;">
            ...
            <div class="form-group">
                <input type="submit" class="btn" value="Login" style="background-color: darkgreen; color:white;">
            </div>
            <p>Don't have an account? <a href="signup.php" style="color:white;">Sign up now</a>.</p>
        </form>
    </div>
    <br>
